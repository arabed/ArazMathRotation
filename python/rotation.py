...
class MathRotation:
    ...
    def drawGrid(self):
        ...
        self.canvas.create_line(x_offset, 0, x_offset, self.h, fill="#8080FF", width=3)
        self.canvas.create_line(0, y_offset, self.w, y_offset, fill="#8080FF", width=3)
...
if __name__ == "__main__":
    ...
    mathRotation.createPolygon([0,0,1,1,2,2])
    root.mainloop()
